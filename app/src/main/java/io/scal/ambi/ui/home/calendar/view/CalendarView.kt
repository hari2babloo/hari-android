...
class CalendarView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) :
    ...
    private var currentSelectedDay = ObservableField<LocalDate>()
    ...
    private val scrollListener = object : RecyclerView.OnScrollListener() {
        ...
        private val currentDateCalculate: Runnable = object : Runnable {
            override fun run() {
                ...
                val selectedDay = currentSelectedDay.get()
                if (null != selectedDay) {
        ...
        disposable?.run {
            calendarViewModel.observeSelectedDay()
                ...
                .subscribe { selectedDay ->
                    currentSelectedDay.set(selectedDay)
            ...
            currentSelectedDay
                ...
                .observeOn(AndroidSchedulers.mainThread())
                .distinctUntilChanged()
                .subscribe { calendarBinding.selectedYearMonth = YearMonth(it) }
                .addTo(this)
        }
    }
